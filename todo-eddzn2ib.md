...
- [ ] Save a checkpoint with all completed items marked.
...
- [ ] Keep the separate Workspace prototype placeholder interactions scoped for a future task; they are not part of this continuation.
