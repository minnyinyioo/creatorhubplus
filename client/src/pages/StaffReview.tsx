...
import { ExternalLink, FileCheck2, FileQuestion, FileWarning, LoaderCircle, RefreshCcw, ShieldCheck, UserRound } from "lucide-react";
...
export const quickReviewActionLabels = { approve: "Approve payment", reject: "Reject payment" } as const;
export function reviewActionLabel(defaultLabel: string, isPending: boolean) { return isPending ? "Saving review…" : defaultLabel; }
...
export function StaffReviewContent() {
