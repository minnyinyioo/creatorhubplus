...
export default function BurmesePrivacy() {
  ...
  return <main className="privacy-page my-site">
    ...
    <footer className="privacy-footer"><p>CreatorHubPlus ကိုယ်ရေးအချက်အလက် မူဝါဒ</p><Link href="/my">CreatorHubPlus သို့ ပြန်သွားရန် <ArrowUpRight size={14} /></Link></footer>
  </main>;
}
